...
export default function MacroProgress({ items, date }: Props) {
  ...
  const stepKcal = steps != null ? Math.round(steps * stats.weightLbs * 0.453592 * 0.0006) : 0;
